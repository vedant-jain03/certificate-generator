...
export class ComponentToPrint extends React.PureComponent {
  render() {
    ...
    switch (this.props.template) {
      ...
      case "template10": {
        return (
          <div style={{ position: "relative" }} id="template10">
            <img
              src={template10}
              style={{ width: "45rem" }}
              alt="Template 10"
            ...
            >
              ...
              <h1 style={{
                  ...
                  color: "#01559F",
                  textDecoration: "underline",
                  textDecorationColor: "#F7AF2F",
                  textUnderlineOffset: "10px"
                }}>
                {this.props.name === "" ? "Name Surname" : this.props.name}
              </h1>
              <p
                style={{
                  fontSize: "15px",
              ...
              >
                {this.props.desc === ""
                  ? "For the successfull completion of course in recognition of your continuing excellence in outstanding performance and lasting contribution."
                  : this.props.desc}
              </p>
            </div>
            <div
      ...
      case "template11":{
          return (
              <div style={{ position: 'relative' }} id="template11">
                  <img
                    src={template11}
                    style={{
                      width: "45rem"
